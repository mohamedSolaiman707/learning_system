...
class _LoginScreenState extends State<LoginScreen>
  ...
  void _showWelcomeOverlay(String userName) {
    ...
    overlayEntry = OverlayEntry(
      builder: (context) => _WelcomeOverlayWidget(userName: userName),
    );
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text(
          _isLogin ? "أهلاً بك مجدداً" : "انضم لأسرتنا",
        ...
        Text(
          _isLogin
              ? "سجل دخولك لمواصلة رحلتك"
              : "أنشئ حساباً للوصول لمصادرك التعليمية",
          ...
          children: [
            ...
            if (!_isLogin) ...[
              CustomTextField(
                ...
                validator: (v) =>
                    (v == null || v.isEmpty) ? "يرجى كتابة اسمك" : null,
              ),
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: isLoading
            ...
            : Text(
                _isLogin ? "تسجيل دخول" : "إنشاء حسابي",
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
      ...
      children: [
        ...
        InkWell(
          ...
          child: Padding(
            ...
            child: Text(
              _isLogin ? "سجل الآن مجاناً" : "سجل دخولك من هنا",
              style: const TextStyle(
                color: Colors.blue,
                fontWeight: FontWeight.bold,
                fontSize: 16,
