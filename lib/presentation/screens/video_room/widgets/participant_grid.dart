...
class ParticipantGrid extends StatelessWidget {
          ...
          builder: (context, layoutState, _) {
            return ListenableBuilder(
              ...
              builder: (context, _) {
                ...
                final participants = ClassroomParticipantUtils.allFromRoom(room);
                final screenSharer =
                    ClassroomParticipantUtils.findScreenSharingParticipant(participants);
  ...
  Widget _buildProfessionalTeacherLayout(
    ...
    final otherParticipants =
        allParticipants.where((p) => p.identity != mainParticipant.identity).toList();
  ...
  Widget _buildStudentLayout(
    ...
    if (screenSharingParticipant != null) {
      final channelParticipant =
          ClassroomParticipantUtils.findChannelParticipant(allParticipants, selectedChannel);
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (participant != null) {
                          return ParticipantTile(
                            ...
                            participant: participant,
                            isMainStage: false,
                            displayName: seat['student_name'] as String? ?? participant.name,
                          );
                        }
  ...
  Widget _buildEmptySeat(int number, String? assignedName) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.person_outline_rounded, color: Colors.white.withOpacity(0.05), size: 24),
          ...
          Text(
            '$number',
            style: TextStyle(color: Colors.white.withOpacity(0.05), fontSize: 8),
          ),
        ],
      ),
    );
  ...
  Widget _buildHybridStudentLayout(
    ...
    return Stack(
      children: [
        ...
        if (camPart != null && ClassroomParticipantUtils.hasCameraVideo(camPart))
          Positioned(
            top: 20,
            right: 20,
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final bool hasVideo = activeVideoTrack != null &&
            (isScreen
                ? ClassroomParticipantUtils.hasScreenShareVideo(participant)
                : ClassroomParticipantUtils.hasCameraVideo(participant));
          ...
          child: Stack(
            children: [
                ...
                child: AnimatedSwitcher(
                  ...
                  child: hasVideo
                      ? VideoTrackRenderer(
                          ...
                          mirrorMode:
                              isMe ? VideoViewMirrorMode.mirror : VideoViewMirrorMode.off,
              ...
              Positioned(
                bottom: 10,
                left: 10,
                child: _buildNameLabel(nameToShow, isMe, participant.isMicrophoneEnabled(), isScreen),
              ),
              Positioned(
                top: 10,
                right: 10,
                child: Row(
                  ...
                  children: [
                    ...
                    if (isSpotlighted)
                      _buildBadge('مشاركة مميزة', Colors.amber.shade700, Icons.star),
